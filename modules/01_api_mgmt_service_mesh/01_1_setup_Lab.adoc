...
+
NOTE: If your network connection is intermittent, consider installing the [mosh](https://mosh.org) utility (`yum install mosh`) as an alternative to the `ssh` utility.
