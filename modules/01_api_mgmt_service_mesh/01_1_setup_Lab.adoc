...
. Click the `Order` button and in the following page, check the checkbox to confirm that you understand and know your runtime and expiration dates.
. Clcik `Submit`
...
[blue]#Congratulations!#  Your lab environment is now properly set-up.  Please proceed to the next lab:  link:01_2_api_mgmt_service_mesh_Lab.html[*01_2 API Mgmt Service Mesh Lab*]
