...
:toc2:
:linkattrs:
:lab_spreadsheet: link:https://docs.google.com/a/redhat.com/spreadsheets/d/e/2PACX-1vTcNkVOAYQJSN0c47zcf7i1ZKZDFUidcY_rdHWWlJquGOAn7Jr-UIMGAaYyKN9jLbe3NP1YGliDsIGW/pubhtml[APAC RHTE: Student lab info spreadsheet]
...
The other component of your lab environment is a 3scale _tenant_ that has been pre-provisioned and dedicated to you.

You will be assigned a dedicated 3scale _tenant_ as well as more information about your lab environments as follows:

. The lab instructor will assign each student a sequential number between 1 and 100 .
+
WARNING: Please make note of this sequential number assigned to you.
If you have not been assigned a number then ask for one from your lab instructor.

. Using that assigned number, you will reference needed lab information in the following spreadsheet: {lab_spreadsheet}

== Environment Variables

. Ensure you've ssh'd into your remote lab environment.

. Once you've ssh'd into your remote terminal window, you'll want to set the following environment variables using the values assigned to you in: {lab_spreadsheet}:
+
-----
...
$ echo "export API_TENANT_SUFFIX=<provided by instructor>" >> ~/.bashrc         # Column E
