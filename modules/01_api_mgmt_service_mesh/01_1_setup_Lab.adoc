...
:toc2:
:linkattrs:
:lab_spreadsheet: link:https://docs.google.com/spreadsheets/d/19Fb4aRYIPWDqUbctXbFvRD7JsT8G_BM9KF5tTo4dWE8/edit?usp=sharing[APAC RHTE: Student lab info spreadsheet]
...
. Add your name to Column C of the spreadsheet.
...
+
-----
$ echo "export API_USERNAME=<column A of spreadsheet>" >> ~/.bashrc
$ echo "export API_ADMIN_ACCESS_TOKEN=<column B of spreadsheet>" >> ~/.bashrc
$ echo 'export API_PASSWD=<column C of spreadsheet>' >> ~/.bashrc
$ echo 'export OCP_PASSWD=<column D of spreadsheet>' >> ~/.bashrc
-----
