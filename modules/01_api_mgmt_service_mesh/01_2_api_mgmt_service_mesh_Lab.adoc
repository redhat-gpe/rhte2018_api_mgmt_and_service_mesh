...
=== Configure and Test: Experienced 3scale users
...
After completing the smoke testing, continue with the section: <<apicast_istio>>.

If you are an experienced user of Red Hat 3scale API Management, skip to the section: <<configuretestapi>>.

If you are not an experienced user of Red Hat 3scale API Management, complete the instructions in <<configuretestapi_stepbystep>>.
