...
For the purpose of this lab, you can delete your API gateway pods instead of waiting for 5 minutes.
...
. Confirm the API gateway related pods have been started.
+
Tail the log file of the new API gateway production pod.
+
