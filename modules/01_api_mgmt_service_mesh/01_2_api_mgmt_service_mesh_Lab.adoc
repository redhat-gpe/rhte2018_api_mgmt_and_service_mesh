...
. From the terminal, conduct a smoke test to validate traffic to the catalog service directly via the Istio ingress gateway:
+
-----
...
=== 3scale Istio Mixer
. Clone the source code to the 3scale Istio Mixer :
+
-----
$ git clone \
