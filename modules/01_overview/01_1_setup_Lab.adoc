...
=== Optional: Re-Installaing `istio-system`
...
. Re-Install Red Hat Service Mesh installation
+
-----
# wget https://bit.ly/2KcUlHf -O $HOME/rht_service_mesh_crd.yaml \
       oc create -f $HOME/rht_service_mesh_crd.yaml \
       -n istio-operator
-----

. Modify _istio_ configmap:
+
-----
