...
/////
. Indicate to the application where to locate its app specific configurations:
+
-----
...
. Allow for optionally debugging of catalog service so as to better understand how exactly it utilizes the opentracing / jaeger java libraries
+
-----
